<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
   ...
   <ul class="nav flex-column nav-pills" id="myTab" role="tablist" aria-orientation="vertical">
      ...
      <li class="nav-item">
         <a class="nav-link" id="professor-tab" data-toggle="tab" href="#professor" role="tab" aria-controls="professor" aria-selected="false">
      ...
      <li class="nav-item">
         <a class="nav-link" id="pad-tab" data-toggle="tab" href="#pad" role="tab" aria-controls="pad" aria-selected="false">
