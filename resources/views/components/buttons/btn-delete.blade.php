...
<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-delete-0">
    <i class="fas fa-trash"></i>
</button>

<!-- Modal -->
<div class="modal fade" id="modal-delete-0" tabindex="-1" role="dialog" aria-labelledby="modal-delete-label"
    aria-hidden="true">
