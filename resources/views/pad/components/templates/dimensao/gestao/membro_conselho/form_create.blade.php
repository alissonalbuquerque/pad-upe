...
<div class="container"> 
    ...
    <div id="gestao_membro_conselho">
        <div>
            ...
            <form action="{{route('gestao_membro_conselho_create')}}" method="post" id="gestao_membro_conselho-form">
                ...
                <div class="mt-1 text-end">
                    @include('components.buttons.btn-save', [
                        'content' => 'Cadastrar',
                        'id' => 'btn-submit_gestao_membro_conselho'
                    ])
                </div>
        ...
        <div class="border rounded px-4 mt-4">
            ...
            <table class="table table-hover" id="gestao_membro_conselho-table">
                <thead>
                    <tr>
                        <!-- <th scole="col">#</th> -->
                        <th scope="col"> Cód </th>
                        <th scope="col"> Nome do Conselho, Comissão, Comitê ou Núcleo </th>
                            ...
                            <div class="btn-group" role="group">
                                <div class="me-1">
                                    @include('components.buttons.btn-edit-task', [
                                        'btn_class' => 'btn-edit_gestao_membro_conselho',
                                        'btn_id' => $atividade->id,
                                    ])
                                </div>
                                <div class="me-1">
                                    @include('components.buttons.btn-delete', [
                                        'id' => $atividade->id,
                                        'route' => route('gestao_membro_conselho_delete', ['id' => $atividade->id])
                                    ])
                                </div>
                            </div>  
                        </td>
...
@section('scripts')
    ...
    @include('pad.components.scripts.ajaxValidation', [
        'btn_submit_id' => 'btn-submit_gestao_membro_conselho',
        'form_id' => 'gestao_membro_conselho-form',
        'form_type' => 'create',
    ...
    @include('pad.components.scripts.dimensao.ensino.show_modal', [
        'modal_id' => 'modal',
        'route' => route('view_gestao_membro_conselho_update'),
        'btn_class' => 'btn-edit_gestao_membro_conselho',
    ])

    @include('pad.components.scripts.dimensao.ensino.show_modal', [
        'modal_id' => 'modal',
        'route' => route('view_gestao_membro_conselho_resolucao'),
        'btn_class' => 'show_resolucao',
    ])
@endsection
