...
<div id="gestao_coordenacao_programa_institucional">
    <div>
        ...
        <form action="{{route('gestao_coordenacao_programa_institucional_update', ['id' => $model->id])}}" method="post" id="gestao_coordenacao_programa_institucional_update-form">
            @csrf
            ...
            <div class="mt-1 text-end">
                <div class="modal-footer">
                    ...
                    @include('components.buttons.btn-save', [
                        'id' => 'btn-submit_gestao_coordenacao_programa_institucional-update',
                        'content' => 'Atualizar',
                    ])
                </div>
            </div>
