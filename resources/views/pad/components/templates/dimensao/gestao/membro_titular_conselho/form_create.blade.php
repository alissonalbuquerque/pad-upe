...
<div class="container"> 
    ...
    <div id="gestao_membro_titular_conselho">
        <div>
            <div class="mb-3">
                <h3 class="h3"> Gestão - Membro Titular dos Conselhos da UPE (CEPE, CONSUN OU CGA) </h3>
                @include('components.buttons.btn-show-resolucao', [
                    'content' => 'Resolução',
                    'btn_class' => 'show_resolucao',
                ])
            </div>
            <form action="{{route('gestao_membro_titular_conselho_create')}}" method="post" id="gestao_membro_titular_conselho-form">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-9">
                        <label class="form-label" for="nome">Nome do Conselho </label>
                ...
                <div class="mt-1 text-end">
                    @include('components.buttons.btn-save', [
                        'content' => 'Cadastrar',
                        'id' => 'btn-submit_gestao_membro_titular_conselho'
                    ])
                </div>
            </form>
        </div>
        ...
        <div class="border rounded px-4 mt-4">
            ...
            <table class="table table-hover" id="gestao_membro_titular_conselho-table">
                <thead>
                    <tr>
                        <!-- <th scole="col">#</th> -->
                        <th scope="col"> Cód </th>
                        <th scope="col"> Nome do Conselho </th>
                    ...
                    <tr>
                        ...
                        <td>
                            @include('components.buttons.btn-edit-task', [
                                'btn_class' => 'btn-edit_gestao_membro_titular_conselho',
                                'btn_id' => $atividade->id,
                            ])

                            @include('components.buttons.btn-delete', [
                                'id' => $atividade->id,
                                'route' => route('gestao_membro_titular_conselho_delete', ['id' => $atividade->id])
                            ])
                        </td>
                    </tr>
                    @endforeach
...
@section('scripts')
    ...
    @include('pad.components.scripts.ajaxValidation', [
        'btn_submit_id' => 'btn-submit_gestao_membro_titular_conselho',
        'form_id' => 'gestao_membro_titular_conselho-form',
        'form_type' => 'create',
    ...
    @include('pad.components.scripts.dimensao.ensino.show_modal', [
        'modal_id' => 'modal',
        'route' => route('view_gestao_membro_titular_conselho_update'),
        'btn_class' => 'btn-edit_gestao_membro_titular_conselho',
    ])

    @include('pad.components.scripts.dimensao.ensino.show_modal', [
        'modal_id' => 'modal',
        'route' => route('view_gestao_membro_titular_conselho_resolucao'),
        'btn_class' => 'show_resolucao',
    ])
@endsection
