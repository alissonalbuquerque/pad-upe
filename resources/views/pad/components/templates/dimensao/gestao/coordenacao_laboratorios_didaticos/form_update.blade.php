...
<div id="gestao_coordenacao_laboratorios_didaticos">
    <div>
        <div class="mb-3">
            <h3 class="h3"> Gestão - Coordenação de Laboratórios Didático, de Informática ou de Ensino </h3 class="h3">
        </div>
        <form action="{{route('gestao_coordenacao_laboratorios_didaticos_update', ['id' => $model->id])}}" method="post" id="gestao_coordenacao_laboratorios_didaticos_update-form">
            @csrf
            ...
            <div class="mt-1 text-end">
                <div class="modal-footer">
                    ...
                    @include('components.buttons.btn-save', [
                        'id' => 'btn-submit_gestao_coordenacao_laboratorios_didaticos-update',
                        'content' => 'Atualizar',
                    ])
                </div>
            </div>
