{{-- 
    @var $model App\Models\Tabelas\Gestao\GestaoCoordenacaoLaboratoriosDidaticos
--}}
...
<div class="my-4 mx-2">
    ...
    <div class="card">
        <div class="card-header">
            Gestão - Coordenação de Laboratórios Didáticos
        </div>
        <div class="card-body">
            <h5><span class="fw-bolder">Cód Atividade: </span> {{ $model->cod_atividade }}</h5>
            <p> <span class="fw-bolder">Nome do Laboratório: </span> {{ $model->nome }} </p>
