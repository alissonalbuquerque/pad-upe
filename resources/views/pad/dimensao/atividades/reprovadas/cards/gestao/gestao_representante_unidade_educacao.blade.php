{{-- 
    @var $model App\Models\Tabelas\Gestao\GestaoRepresentanteUnidadeEducacao
...
<div class="my-4 mx-2">
    ...
    <div class="card">
        <div class="card-header">
            Gestão - Representante nas Unidades de Educação
        </div>
        <div class="card-body">
            <h5><span class="fw-bolder">Cód Atividade: </span> {{ $model->cod_atividade }}</h5>

            <p> <span class="fw-bolder">Documento Comprobatório da Representação Sindical: </span> {{ $model->nome }} </p>
