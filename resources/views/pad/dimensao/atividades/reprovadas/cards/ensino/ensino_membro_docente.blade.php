...
<div class="my-4 mx-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p> <span class="fw-bolder">Nome do núcleo docente estruturante / estruturante assistencial: </span> {{ $model->tarefa->nucleo }} </p>
            <p> <span class="fw-bolder">Documento que o designa (Portaria, Ordem de serviço ou Outro): </span> {{ $model->tarefa->documento }} </p>
