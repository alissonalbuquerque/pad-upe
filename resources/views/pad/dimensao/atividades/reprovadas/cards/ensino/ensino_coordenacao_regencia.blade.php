{{-- 
    @var $model App\Models\Tabelas\Ensino\EnsinoCoordenacaoRegencia
--}}
...
<div class="my-4 mx-2">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p> <span class="bolded">Componente Curricular: </span> {{ $model->componente_curricular }} </p>
            <p> <span class="bolded">Curso: </span> {{ $model->curso }} </p>
            <p> <span class="bolded">Nível: </span> {{ $model->nivelToString() }} </p>
            <p> <span class="bolded">Modalidade: </span> {{ $model->modalidadeToString() }} </p>
